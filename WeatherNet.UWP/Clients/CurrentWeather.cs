...
namespace WeatherNet.Clients
{
    public class CurrentWeather
    {
        ...
        public async static Task<SingleResult<CurrentWeatherResult>> GetByCityName(String city, String country)
        {
            try
            {
                ...
                var response = await ApiClient.GetResponse("/weather?q=" + city + "," + country);
        ...
        public static async Task<SingleResult<CurrentWeatherResult>> GetByCityName(String city, String country, String language, String units)
        {
            try
            {
                if (String.IsNullOrWhiteSpace(city) || String.IsNullOrEmpty(country))
                    return new SingleResult<CurrentWeatherResult>(null, false, "City and/or Country cannot be empty.");
                var response = await ApiClient.GetResponse("/weather?q=" + city + "," + country + "&lang=" + language + "&units=" + units);
                return Deserializer.GetWeatherCurrent(response);
            }
            catch (Exception ex)
            {
        ...
        /// <returns> The weather information.</returns>
        public static async Task<SingleResult<CurrentWeatherResult>> GetByCoordinates(double lat, double lon)
        {
            try
            {
                var o = await ApiClient.GetResponse("/weather?lat=" + lat + "&lon=" + lon);
        ...
        /// <param name="units">The units of the date (metric or imperial).</param>
        /// <returns> The weather information.</returns>
        public static async Task<SingleResult<CurrentWeatherResult>> GetByCoordinates(double lat, double lon, String language, String units)
        {
            try
            {
                var o = await ApiClient.GetResponse("/weather?lat=" + lat + "&lon=" + lon + "&lang=" + language + "&units=" + units);
                return Deserializer.GetWeatherCurrent(o);
            }
            catch (Exception ex)
            {
        ...
        /// <returns> The weather information.</returns>
        public static async Task<SingleResult<CurrentWeatherResult>> GetByCityId(int id)
        {
            try
            {
                if (0 > id)
                    return new SingleResult<CurrentWeatherResult>(null, false, "City Id must be a positive number.");
                var o = await ApiClient.GetResponse("/weather?id=" + id);
                return Deserializer.GetWeatherCurrent(o);
            }
            catch (Exception ex)
            {
        ...
        /// <param name="units">The units of the date (metric or imperial).</param>
        /// <returns> The weather information.</returns>
        public static async Task<SingleResult<CurrentWeatherResult>> GetByCityId(int id, String language, String units)
        {
            try
            {
                if (0 > id)
                    return new SingleResult<CurrentWeatherResult>(null, false, "City Id must be a positive number.");
                var o = await ApiClient.GetResponse("/weather?id=" + id + "&lang=" + language + "&units=" + units);
                return Deserializer.GetWeatherCurrent(o);
            }
            catch (Exception ex)
            {
